...
export async function initializeDatabase() {
    try {
        ...
        try {
            ...
            `);
            console.log('[DATABASE] Automations tables initialized');
        } catch (migErr) {
            console.warn('[DATABASE] Automations migrations warning:', migErr.message);
        }
