        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900 flex items-center justify-center p-6">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl p-6 md:p-8 shadow-2xl">
                    <h2 className="text-2xl md:text-3xl font-bold text-white mb-1 text-center">Criar Conta</h2>
                    <p className="text-purple-200 text-center mb-6">Comece a automatizar suas vendas</p>
